...
export class ProfileView {
    constructor(username, isMyProfile = true) {
        ...
        <div id="editProfilePopup" class="text-black font-mono fixed inset-0 hidden items-center justify-center  bg-black/50 backdrop-blur-sm  z-50">
          <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
            ...
            <div class="flex flex-col items-center">
              <img id="editAvatarPreview" src="./src/imgs/cat.jpg" alt="Avatar Preview" class="w-24 h-24 rounded-full mb-2 object-cover" />
              <img src="./src/imgs/cat.jpg" class="w-12 h-12 rounded-full border object-cover cursor-pointer hover:ring-2 hover:ring-blue-500 " />



              <input type="file" id="avatarInput" accept="image/*" class="hidden" />
              <button id="chooseFileBtn" type="button" class="px-4 py-2 my-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                Choose Avatar
              </button>   
    ...
    onMounted() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.setupProfileDefault();
                if (this.isMyProfile) {
    ...
    handleEditProfile() {
        ...
        form.addEventListener("submit", (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield fetch("/api/v1/user/me", {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
